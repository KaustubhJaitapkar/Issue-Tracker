...
const ExpiringLicenses = () => {
    ...
    const fetchLicenses = () => {
        fetch('http://localhost:5000/expiring-licenses')
    ...
    return (
        ...
        //     <h2 className="text-2xl font-semibold mb-4">Expiring Licenses</h2>
        //     {licenses.length === 0 ? (
    ...
    <div className="w-full max-w-6xl bg-white shadow-lg rounded-xl p-6">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Expiring Licenses</h2>
        ...
        {licenses.length === 0 ? (
            ...
            <div className="overflow-x-auto border border-gray-300 rounded-lg">
                <table className="w-full text-sm md:text-base border border-gray-300 rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        {licenses.map((license) => (
                            <tr key={license.id} className="hover:bg-gray-50 transition duration-200 text-center">
                                {editId === license.id ? (
                                    <>
                                    ...
                                    <>
                                        <td className="border px-4 py-2">{license.file_name}</td>
                                        <td className="border px-4 py-2">{license.expiry_date}</td>
                                        <td className="border px-4 py-2">{license.department_id}</td>
                                        <td className="border px-4 py-2">
                                            <a
                                                href={`http://localhost:5000/${license.file_path}`}
                                                download
